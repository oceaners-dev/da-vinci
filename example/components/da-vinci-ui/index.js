...
var Link = forwardRef(function (props, ref) {
    ...
    return (React__default.createElement(CustomLink, __assign({}, rest, { className: "py-2 flex flex-row items-center justify-center text-gray-600 hover:bg-gray-200 hover:button-classes ".concat(!icon ? 'px-2' : '', " ").concat(isActive && 'button-classes', " ").concat(className), ref: ref }),
        icon && (React__default.createElement("div", { className: "px-2 [&>svg]:w-6 [&>svg]:h-6  leading-none" }, icon)),
        React__default.createElement("div", { className: "w-full max-w-[150px] font-medium" }, children)));
});
